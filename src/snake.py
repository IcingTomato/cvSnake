...
game = SnakeGameClass("tomato.png") # 食物图片可以自己随便换
...
while True:
    ...
    if (time.time() - start_time) != 0:  # 实时显示帧数
        CV2.putText(img, "FPS {0}".format(float('%.1f' % (counter / (time.time() - start_time)))), (500, 50),
                    CV2.FONT_HERSHEY_SIMPLEX, 2, (0, 0, 255),
                    3)
        src = CV2.resize(img, (1280 // 2, 720 // 2), interpolation=CV2.INTER_CUBIC)  # 窗口大小
